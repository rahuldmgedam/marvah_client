...
//             ) : (
//               filteredData.map((item, index) => {
//                 const previousDay = getPreviousDayData(filteredData, index);

//                 // Check if current day's value differs from previous day, if yes, highlight in pink
//                 const msChanged = previousDay && item.ms !== previousDay.ms;
//                 const speedChanged = previousDay && item.speed !== previousDay.speed;
//                 const hsdChanged = previousDay && item.hsd !== previousDay.hsd;
