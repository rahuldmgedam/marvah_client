...
//   return (
//     <div className="">
//       <h1 className="text-3xl text-white bg-[#7b1fa2] p-3 uppercase font-bold text-center mb-3">
//         Reports
//       </h1>
...
//       {/* Filters */}
//       <table className="mb-4 w-[95%] ml-4">
//         <tbody>
    ...
    <div className="">
      ...
      <div className="flex justify-between w-[100%] mb-2">
        ...
        <button
            ...
            onClick={() => navigate("/consolidatedReport")}
          >
            Consolidated Report
          </button>
          <button
      ...
      <table className="mb-4 w-[90%] ml-10 px-16 border border-gray-400">
        <thead className="bg-[#008b8b]">
          <tr className="text-white">
            ...
            <th className="border border-gray-400 p-2">Period Type</th>
                ...
                return (
                  <tr key={index}>
                    ...
                    {(product === 'MS' || product === 'ALL') && (
                      <td
                        className={`border-2 border-gray-300 text-center p-2 w-[20] ${msChanged ? "bg-pink-200" : ""
                          }`}
                      >
                        {item.ms || "--"}
                      </td>
                    ...
                    {(product === 'Speed' || product === 'ALL') && (
                      <td
                        className={`border-2 border-gray-300 text-center p-2 w-[20] ${speedChanged ? "bg-pink-200" : ""
                          }`}
                      >
                        {item.speed || "--"}
                      </td>
                    ...
                    {(product === 'HSD' || product === 'ALL') && (
                      <td
                        className={`border-2 border-gray-300 text-center p-2 w-[20] ${hsdChanged ? "bg-pink-200" : ""
                          }`}
                      >
                        {item.hsd || "--"}
                      </td>
