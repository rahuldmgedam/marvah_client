...
import { creatCreditTran, deleteCreditTranData, getCreditData, getCreditTranData } from '../../servises/opretions/credit';
import { getHsdData, getMsData, getSpeedData } from '../../servises/opretions/fuel';
                ...
                <div>
                    ...
                    <table className="table" >
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <select className="form-select editableInput w-[12rem]" value={formData?.clientName} aria-label="Default select example" name='client' onChange={handlchenges}>
                                ...
                                <td>
                                    <input type="text" className="form-control editableInput bigFontWeight" placeholder="Bill No" onChange={handlchenges} name='billNo' value={formData?.billNo} />
                                </td>
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setFormData((pre) => ({ ...pre, [e.target.name]: value }));
                                ...
                                <td scope="row" >
                                    <select className="form-select editableInput" name='productName' value={formData?.productName} aria-label="Default select example" onChange={handlchenges}>
                                ...
                                <td>
                                    <input type="text" className="form-control  bigFontWeight" value={formData?.rate} placeholder="Rate" onChange={handlchenges} disabled />
                                </td>

                                <td>
                                    <input type="text" className="form-control bigFontWeight" value={formData?.quantity} name='quntity' placeholder="Quantity" onChange={handlchenges} disabled />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table className="table" >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><button type="button" className="btn btn-success" onClick={creatCreditTranHandler} >Save</button></td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            {thistory?.map((res, index) =>
                                <tr className='hovereffect' key={index}>
                                    ...
                                    <td>{res.quantity}</td>
                                    <td style={{ width: '50px' }}>
                                        <button type="button" style={{ height: '30px', paddingTop: '2px' }} id={"data" + res.credit_client_id} onClick={() => handleDelet(res._id)} className="btn btn-danger" >Delete</button>
                                    </td>
                                </tr>
                            )}
