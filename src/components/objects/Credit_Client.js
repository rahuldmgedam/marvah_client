...
export default function Handloans({ dbpath1 }) {
  ...
  return (
    <>
      <div className="tankMainDiv shadow-lg px-3 bg-body-tertiary rounded bigFontWeight">
      <div className='bg-white top-14  w-[100%] z-1 py-2 mb-12 fixed'>
                    <div className='w-[40%]  flex items-center justify-between gap-6'>
                    <span className='text-xl'> Date : {new Date().toLocaleDateString()} </span>
                    <h2 className='text-3xl'>Credit Client</h2>
        ...
        <div>
          <br></br>
          <h5 className='flex items-center justify-end mr-8 gap-4 mt-10 fixed right-0 top-8 z-20'> <span style={{  }}>Outstanding : {outstanding}</span> <span style={{  }}>Total Outstanding : </span> {TOutstanding}</h5>
          <br></br>
          <div className="border border-gray-300 px-2 max-h-80 overflow-y-auto relative">
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-[#008B8B]">
                <th className="bg-[#008B8B] text-white border-b border-gray-300 p-2 text-left font-semibold">Party Name</th>
                <th className="bg-[#008B8B] text-white border-b border-gray-300 p-2 text-left font-semibold">Bill No</th>
                <th className="bg-[#008B8B] text-white border-b border-gray-300 p-2 text-left font-semibold">Amount</th>
                <th className="bg-[#008B8B] text-white border-b border-gray-300 p-2 text-left font-semibold">Product Name</th>
                <th className="bg-[#008B8B] text-white border-b border-gray-300 p-2 text-left font-semibold">Rate</th>
                <th className="bg-[#008B8B] text-white border-b border-gray-300 p-2 text-left font-semibold">Quantity in Liter</th>
              </tr>
            </thead>
            <tbody>
              <tr>
          ...
          <div className="border border-gray-300 px-2 max-h-80">
          <table className="table relative left-[25rem] w-[48rem] ">
            <thead>
              <tr className="table-secondary">
                <th className="tablebg">Amount in Word</th>
          ...
          <table className="w-full border-collapse">
            <thead className="z-10">
              <tr className="bg-[#008B8B] text-white">
                <th className="sticky z-10 top-0 bg-[#008B8B] p-2 font-semibold">Sr.</th>
                <th className="sticky z-10 top-0 bg-[#008B8B] p-2 font-semibold">Name</th>
                <th className="sticky z-10 top-0 bg-[#008B8B] p-2 font-semibold">Bill No</th>
                <th className="sticky z-10 top-0 bg-[#008B8B] p-2 font-semibold">Amount</th>
                <th className="sticky z-10 top-0 bg-[#008B8B] p-2 font-semibold" style={{ width: "100px" }}>
                  Product Name
                </th>
                <th className="sticky z-10 top-0 bg-[#008B8B] p-2 font-semibold">Rate</th>
                <th className="sticky z-10 top-0 bg-[#008B8B] p-2 font-semibold">Qty</th>
