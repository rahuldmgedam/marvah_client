                ...
                <div className="w-[90%] m-auto ">
                  ...
                  <div className="flex ">
                    ...
                    <div className=" gap-2 w-[40%] font-semibold bg-slate-100  ">
                        ...
                        {machine.nozzleLayout.length === 4  &&
                        machine.nozzleLayout.map((nozzleLayout, index) => {
                          // Extracting the "2-MS" part from the product field
                          const modifiedFuelType = index === 1 ? `${msProductData[1]?.product.split("-")[1]}-${msProductData[1]?.product.split("-")[2]}`
                            : index === 3 ? `${msProductData[1]?.product.split("-")[1]}-${msProductData[1]?.product.split("-")[2]}`
                              : nozzleLayout.fuletype;

                          return (
                            <div className="flex border-b-2 w-[100%] px-10 mt-[13px]" key={index}>
                              <div className="w-[60%]">
                                {nozzleLayout.nozzlename}
                              </div>
                              <div className="justify-start">
                      ...
                      {/* {(machine.nozzleLayout.length === 6 ||
                        ...
                        machine.nozzleLayout.map((nozzleLayout, index) => {
                          return (
                            <div className="flex border-b-2 w-[100%] px-10" key={index}>
                              <div className="w-[60%] ">
                                {nozzleLayout.nozzlename}
                              </div>
                              <div className="justify-start ">
                      ...
                      {(machine.nozzleLayout.length === 6 || machine.nozzleLayout.length === 5) &&
                        machine.nozzleLayout.map((nozzleLayout, index) => {
                          // Extracting the "2-MS" part from the product field
                          const modifiedFuelType = index === 2 ? `${msProductData[1]?.product.split("-")[1]}-${msProductData[1]?.product.split("-")[2]}`
                            : index === 5 ? `${msProductData[1]?.product.split("-")[1]}-${msProductData[1]?.product.split("-")[2]}`
                              : nozzleLayout.fuletype;
