...
const Planner = () => {
    const [selectedOption, setSelectedOption] = useState('Policy');
    const [fetchAAddPlanner, setFetchAddPlanner] = useState([])
    const [formData, setFormData] = useState({
        policyHolder: '',
        policyName: '',
        policyNo: '',
    ...
    const fetchAddPlannerData = async () => {
        try {
            const response = await axios.get("http://localhost:4000/addPlanner");
            const data = await response.data;
            const filteredData = data.filter(item => item.category === selectedOption);
            setFetchAddPlanner(filteredData);

            if (filteredData.length > 0) {
                setFormData({
                    holderName: filteredData[0].holderName || "",
                    name: filteredData[0].name || "",
                });
            } else {
                setFormData({ holderName: "", name: "" });
            }
        } catch (error) {
            console.log("AddPlanner Data Error:", error);
        }
    };
    ...
    return (
        <div className="p-6 w-full mx-auto relative">
            ...
            <div className="flex gap-6 container mx-auto">
                {/* {selectedOption === 'Policy' && (
                    <div className="space-y-4 flex-1">
                        ...
                        <div className='flex gap-2'>
                            <label className="font-bold block">Policy Holder Name:</label>
                            <input
                                type="text"
                                name="policyHolder"
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div className='flex gap-2'>
                                <label className="font-bold">Paying Term:</label>
                                <select
                                    name="dateMode"
                                    value={formData.dateMode}
                                    onChange={handleChange}
                ...
                {selectedOption === 'Policy' && (
                    <div className="space-y-4 flex-1">
                        <h1 className="text-center text-2xl font-bold bg-[#008B8B] text-white py-1">Policy Details</h1>

                        <div className="flex items-center gap-2">
                            <label className="font-bold w-1/4">Policy Holder Name:</label>
                            <input
                                type="text"
                                name="policyHolder"
                                value={formData.holderName}
                                onChange={handleChange}
                                className="border border-black rounded w-3/4 p-2"
                            />
                        </div>

                        <div className="flex items-center gap-2">
                            <label className="font-bold w-1/4">Policy Name:</label>
                            <input
                                type="text"
                                name="policyName"
                                value={formData.name}
                        ...
                        <div className="flex items-center gap-2">
                            <label className="font-bold w-1/4">Policy No:</label>
                            <input
                                type="text"
                                name="policyNo"
                                value={formData.policyNo}
                        ...
                        <div className="flex items-center gap-2">
                            <label className="font-bold w-1/4">Policy Start Date:</label>
                            <input
                                type="date"
                                name="policyStartDate"
                                value={formData.policyStartDate}
                        ...
                        <div className="flex items-center gap-2">
                            <label className="font-bold w-1/4">Policy End Date:</label>
                            <input
                                type="date"
                                name="policyEndDate"
                                value={formData.policyEndDate}
                        ...
                        <div className="flex items-center gap-2">
                            <label className="font-bold w-1/4">Paying Term:</label>
                            <select
                                name="dateMode"
                                value={formData.dateMode}
                                onChange={handleChange}
                        ...
                        <div className="flex items-center gap-2">
                            <label className="font-bold w-1/4">Date:</label>
                            <input
                                type="date"
                                name="policyDate"
                                value={formData.policyDate}
                        ...
                        <div className="flex items-center gap-2">
                            <label className="font-bold w-1/4">Policy Amount:</label>
                            <input
                                type="number"
                                name="policyAmount"
                                value={formData.policyAmount}
                        ...
                        <div className='flex gap-4'>
                            <div className='flex-1'>
                                ...
                                >
                                    <option value="Monthly">Monthly</option>
                                    <option value="Yearly">Yearly</option>
                                    <option value="Contraly">Quatarly</option>
                                </select>
                            </div>
                            <div className='flex-1'>
                                <label className="font-bold">Date:</label>
                ...
                {/* <div className="space-y-4 flex-1">
                    ...
                    {(formData.paymentMode === 'Online' || formData.paymentMode === 'ECS') && (
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <label className="font-bold">Bank Name:</label>
                                <input
                    ...
                    <div className='flex gap-2'>
                        ...
                        <input
                            ...
                            value={formData.bankPaymentAmount}
                            onChange={handleChange}
                            className="border border-black rounded w-full p-2"
                        />
                    </div>
                ...
                <div className="space-y-4 flex-1">
                    <div className="flex items-center gap-2">
                        <label className="font-bold w-1/4">Agent Name:</label>
                        <input
                            type="text"
                            name="contactPerson"
                            value={formData.contactPerson}
                    ...
                    <div className="flex items-center gap-2">
                        <label className="font-bold w-1/4">Contact Number:</label>
                        <input
                            type="number"
                            name="contactNo"
                            value={formData.contactNo}
                    ...
                    <h1 className="text-center text-2xl font-bold bg-[#008B8B] text-white py-1">Bank Details</h1>

                    <div className="flex items-center gap-2">
                        <label className="font-bold w-1/4">Payment Mode:</label>
                        <select
                            name="paymentMode"
                            value={formData.paymentMode}
                            onChange={handleChange}
                    ...
                    {(formData.paymentMode === 'Online' || formData.paymentMode === 'ECS') && (
                        <div className="flex gap-4">
                            <div className="flex-1 flex items-center gap-2">
                                <label className="font-bold w-1/4">Bank Name:</label>
                                <input
                                    type="text"
                                    name="bankName"
                                    value={formData.bankName}
                            ...
                            <div className="flex-1 flex items-center gap-2">
                                <label className="font-bold w-1/4">Account No:</label>
                                <input
                                    type="text"
                                    name="accountNo"
                                    value={formData.accountNo}
                    ...
                    <div className="flex items-center gap-2">
                        <label className="font-bold w-1/4">Payment Date:</label>
                        <input
                            type="date"
                            name="paymentDate"
                            value={formData.paymentDate}
                    ...
                    <div className="flex items-center gap-2">
                        <label className="font-bold w-1/4">Payment Amount:</label>
                        <input
                            type="text"
                            name="bankPaymentAmount"
                            value={formData.bankPaymentAmount}
                    ...
                    <>
                        ...
                        <table className="table-auto w-full text-left border border-black mb-6">
                            ...
                            <tbody>
                                {savedData.Policy.map((data, index) => (
                                    <tr key={index}>
                                        <td className="p-2 border border-black">{data.holderName}</td>
                                        <td className="p-2 border border-black">{data.name}</td>
                                        <td className="p-2 border border-black">{data.policyNo}</td>
                                        <td className="p-2 border border-black">{data.policyStartDate}</td>
                                        <td className="p-2 border border-black">{data.policyEndDate}</td>
                                        <td className="p-2 border border-black">{data.policyAmount}</td>
