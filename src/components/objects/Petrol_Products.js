...
//       `https://marvah-server.onrender.com/petrol/delete/${id}`
//     );
//     if (res.data.success) {
//       alert(res.data.msg);
//       fetPetrol();
...
//             </div>
//           </div>
//           <table className="table w-[90%] ml-4">
//             <thead>
...
//             <h1 className="uppercase font-bold mt-2 mb-2">invoice index</h1>

//             <table class="w-[80%] bg-white">
...
//             <h1 className="uppercase mb-2 mt-2 font-bold">LFR index</h1>
...
//               </tbody>
//             </table>
//             <h1 className="uppercase mb-2 font-bold mt-2">TDS index</h1>
...
//   return (
//     <>
//       <div className="flex items-center bg-white fixed z-1 w-[80%] justify-between px-8">
//         <h2 className="text-center p-2 text-2xl ml-[20%] font-bold tracking-wider">
//           INDEX FORM INVOICE/TDS/LFR
//         </h2>
//         <button
//           className="bg-blue-500 px-4 py-2 rounded-md mt-2 text-white"
//           onClick={() => navigate("/Petrol_Invoice_Feeding")}
//         >
//           back
//         </button>
...
//       <div className="w-[90%]  relative  container mx-auto mt-8 shadow-sm bg-body-tertiary p-2 rounded">
//         <div className="mt-4 ">
//           <table className="table w-[90%]">
//             <thead>
//               <tr className="table-secondary text-center uppercase">
//                 <th className="w-[90px]">Product</th>
//                 <th className="w-[90px]">Rate/PerUnit</th>
//                 <th className="w-[90px]">Tax. Amt per unit</th>
//                 <th className="w-[90px]">VAT/LST %</th>
//                 <th className="w-[90px]">CESS per unit</th>
//                 <th className="w-[90px]">TCS per unit</th>
//                 <th className="w-[90px]">
//                   (194Q) <br /> TDS(%)
//                 </th>
//                 <th className="w-[90px]">LFR per KL</th>
//                 <th className="w-[90px]">CGST(%)</th>
//                 <th className="w-[90px]">SGST(%)</th>
//                 <th className="w-[90px]">
//                   (194I)TDS<br />(LFR)(%)
//                 </th>
//               </tr>
...
//         <div className="ml-12">
//           <div class="overflow-x-auto font-[sans-serif]">
//             <h1 className="uppercase font-bold   mb-2">invoice index</h1>
            ...
            <form class="space-y-4 mt-8 font-bold">
              ...
              <div className="flex flex-col w-[24%]">
                ...
                <input
                  ...
                  name="tds"
                  onChange={handleChangeUpdate}
                  class="px-4 py-1.5 text-sm w-24 rounded-md bg-white border border-gray-400  outline-blue-500"
                />
              </div>
