...
const loadOutstanding = async (name) => {
    ...
    <>
        <div className='tankMainDiv shadow-lg p-3 mb-5 bg-body-tertiary rounded bigFontWeight'>   
            ...
            <b style={{fontSize:'22px'}}> Date : {datecache}</b>
            <div>
                <br></br><br></br>
              <h5> <span style={{marginLeft:'600px', marginTop:'10px'}}>Outstanding : {outstanding}</span> <span style={{marginLeft:'50px', marginTop:'10px'}}>Total Outstanding : </span> {TOutstanding}</h5>
                ...
                <table class="table" >
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <select class="form-select" value={partyname}  aria-label="Default select example" onChange={(e) => {setPartyname(e.target.value); getBalance(e.target.value); loadOutstanding(e.target.value)}}>
                        ...
                        <td><input type="text" class="form-control" placeholder="Bill No" onChange={(e) => setBillNo(e.target.value)} /></td>
                        <td><input type="text" class="form-control"  placeholder="Amount" onChange={(e) =>{ setAmount(e.target.value); numberToWords(e.target.value);}} /></td>
                           
                        <td scope="row" >
                            <select class="form-select" value={productName}  aria-label="Default select example" onChange={(e) => {setProductName(e.target.value);  loadPrice(e.target.value)}}>
                           ...
                           {/*  <td>
                            ...
                            <td><input type="text" class="form-control" value={rate} placeholder="Rate" onChange={(e) => setRate(e.target.value)} /></td>
                            
                            <td><input type="text" class="form-control" value={quantity} placeholder="Quantity" onChange={(e) => setQuantity(e.target.value)} /></td>
                ...
                <table class="table" >
                    <thead>
                        ...
                        <th className='tablebg' style={{width:'200px'}}>Vehicle No</th>
                    ...
                    <tbody>
                        ...
                        <td><input type="text" class="form-control" placeholder="Vehicle No" onChange={(e) => setVehicleNo(e.target.value)} /></td>
                        <td style={{width:'750px'}}><b>{amountInWord}</b></td>
                ...
                <table class="table">
                    <thead>
                        <tr className='table-secondary'>
                             ...
                             <th className='tablebg'>Bill No</th>
                             <th className='tablebg'>Amount</th>
                             <th className='tablebg' style={{width:'100px'}}>Product Name</th>
                             <th className='tablebg'>Rate</th>
                             <th className='tablebg'>Qty</th>
                             <th className='tablebg'>Vehicle No</th>
                             <th className='tablebg'>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    {thistory.map((res,index)=>
                                <tr className='hovereffect' key={index}>
                                    ...
                                    <td>{res.vehicleno}</td>
                                    <td style={{width:'50px'}}>
                                        <button type="button" style={{height:'30px', paddingTop:'2px'}} id={"data"+res.credit_client_id} class="btn btn-primary" onClick={() => onDelete(res.credit_client_id)}>Delete</button>
                                    </td>
                                </tr>
                            )}
