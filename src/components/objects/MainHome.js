      ...
      <section className="storage-cont">
        <div class="font-sans overflow-x-auto">
          <table class="min-w-full divide-y divide-black-200 border-2 mb-7">
            <thead class="bg-gray-800 whitespace-nowrap">
              <tr>
                <th class="px-4 py-2 text-center text-sm font-bold text-white uppercase tracking-wider">
                  TANK NO
                </th>
                <th class="px-4 py-2 text-center text-sm font-bold text-white uppercase tracking-wider">
                  PRODUCT
            ...
            <tbody class="bg-slate-100 divide-y divide-gray-200 whitespace-nowrap">
              {tank.length > 0 &&
                tank.map((item) => (
                  <tr key={item._id}>
                    <td class="px-4 py-2 text-sm text-center text-gray-800 font-bold">
                      {item.tankNo}
                    </td>
                    <td class="px-4 py-2 text-sm text-center text-gray-800 font-bold">
                      {item.product}
                    ...
                    <td class="px-4 py-2 text-sm text-center text-gray-800 font-extrabold">
                      <button
                        class="bg-blue-500 text-white rounded-md px-3 py-1 mr-4"
                        onClick={() => handleEdit(item)}
                      >
