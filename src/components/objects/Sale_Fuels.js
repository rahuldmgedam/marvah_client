    ...
    <main className="tankMainDiv  shadow-lg p-1 bg-body-tertiary rounded bigFontWeight min-h-fit">
      ...
      <section className="ms-1 mt-16">
        ...
        <div className="flex justify-between w-[90%] ml-4">
          <button></button>
          <button
        className={`${isRed ? 'bg-red-600' : 'bg-green-600'} px-3 tracking-wide mr-2 my-2 py-2 rounded-md text-white font-bold`}
        onClick={handleSave}
      >
        Save
      </button>
      ...
      <section className="ms-2">
          ...
          <tbody>
            {hsdReadings.map((item3, index) => (
              ...
              >
                ...
                <td>
                  <input
                    value={item3.sale3 !== undefined ? item3.sale3 : ""}
                    className="text-center w-32"
                    readOnly
                  />
                </td>
        ...
        <div className="flex justify-between w-[90%] ml-4">
          <button></button>
          <button
        className={`${isRed3 ? 'bg-red-600' : 'bg-green-600'} px-3 tracking-wide mr-2 my-2 py-2 rounded-md text-white font-bold`}
        onClick={handleSave3}
      >
        Save
      </button>
